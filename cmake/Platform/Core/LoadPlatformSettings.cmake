#=============================================================================#
# TODO DO NOT !! refactor as function it brakes CMake trace
# [PRIVATE/INTERNAL]
#
...
if (NOT ${SETTINGS_LIST} AND EXISTS ${SETTINGS_PATH})
    ...
    foreach (FILE_ENTRY ${FILE_ENTRIES})
        if ("${FILE_ENTRY}" MATCHES "^[^#]+=.*")
            ...
            message(VERBOSE "${FILE_ENTRY}")
            # rename pnum in stm32 <board|platform>s.txt
            string(REGEX REPLACE "^(.*)[.]pnum[.](.+)" "\\1.cpu.\\2" SETTING_NAME "${SETTING_NAME}")
            message(VERBOSE "-${SETTING_NAME}")
            ...
            if ("${ENTRY_NAME_TOKENS_LEN}" LESS 2)
                message(VERBOSE "Skip token [${ENTRY_NAME_TOKENS}]")
                continue()
            endif ()
            ...
            if (ENTRY_NAME STREQUAL "menu")
                message(VERBOSE "Skip token [${ENTRY_NAME}]")
                continue()
            endif ()
            ...
            if (ENTRY_NAME_INDEX LESS 0)
                ...
                message(VERBOSE "Add [${ENTRY_NAME}] to [${SETTINGS_LIST}]")
            endif ()
            ...
            if (ENTRY_NAME_TOKENS_LEN GREATER 5)
                ...
                message(VERBOSE "---CPU add [${ENTRY_SETTING}]")
            else ()
                list(GET ENTRY_NAME_TOKENS 1 ENTRY_SETTING)
                message(VERBOSE "---set [${ENTRY_SETTING}]")
            endif ()
            ...
            message(VERBOSE "-----FULL NAME ${FULL_SETTING_NAME}")
            ...
            if (ENTRY_NAME_TOKENS_LEN GREATER 2)
                ...
                message(VERBOSE "    longer 2: ${ENTRY_SUBSETTING_LIST}")
                if (ENTRY_NAME_TOKENS_LEN GREATER 5)
                ...
                elseif (ENTRY_NAME_TOKENS_LEN GREATER 3)
                    ...
                    if ("${ENTRY_SUBSETTING}" STREQUAL "cpu")
                        ...
                        message(VERBOSE "    longer 3 cpu: ${ENTRY_SUBSETTING_LIST}")
                    endif ()
                else ()
                    list(GET ENTRY_NAME_TOKENS 2 ENTRY_SUBSETTING)
                endif ()
