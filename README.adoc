...
See spindle.txt example. Device read only first line, skip everything above.  
Line length limited to 99 chars, 9 2-byte integer values delimited with comas. First "0" is not needed, it always presents.
